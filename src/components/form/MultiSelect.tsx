    ...
    <div className="w-full" ref={dropdownRef}>
      ...
      <div className="relative z-20 inline-block w-full">
        <div className="relative flex flex-col items-center">
          ...
          >
            <div
              className={`mb-2 flex min-h-11 rounded-lg border border-gray-300 py-1.5 pl-3 pr-3 shadow-theme-xs outline-hidden transition focus:border-brand-300 focus:shadow-focus-ring ${
                disabled
            ...
            >
              <div className="flex flex-wrap flex-auto gap-2">
                {selectedOptions.length > 0 ? (
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          disabled={disabled}
                          className="pl-2 text-gray-500 cursor-pointer group-hover:text-gray-400 disabled:cursor-not-allowed"
                  ...
                  <div className="w-full h-full p-1 pr-2 text-sm text-gray-400 pointer-events-none">
                    {placeholder}
                  </div>
                )}
              </div>
              <div className="flex items-center self-start py-1 pl-1 pr-1 w-7">
                <button
                  ...
                  disabled={disabled}
                  className="w-5 h-5 text-gray-700 outline-hidden cursor-pointer focus:outline-hidden disabled:cursor-not-allowed"
                >
                  <svg
