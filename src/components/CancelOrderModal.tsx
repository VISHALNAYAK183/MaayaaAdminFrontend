    ...
    <div className="space-y-3">
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full text-sm px-3 py-2 border border-gray-200 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-500 transition-colors"
        />
      </div>
